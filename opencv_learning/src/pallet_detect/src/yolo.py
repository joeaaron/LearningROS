...
camera_topic = '/colormap'      
flag_publishImg = 1

inputSize = (416, 416)
count = 0
param_cfg = 'cfg/pallet.cfg'
param_model = 'pallet.weights'
param_class_name = 'data/pallet.names'
min_confidence = 0.7

path_load_image = '/home/hrg/Z/test_ws/src/YOLO_python_ROS/src/darknet/data/dog.jpg'
path_darknet = '/home/hrg/Z/test_ws/src/YOLO_python_ROS/src/darknet/'

# params = "{ help           | false | print usage         }"
#       "{ cfg            |  /home/catkin_ws/src/yolo/src/darknet/cfg/yolo.cfg     | model configuration }"
#       "{ model          |  /home/catkin_ws/src/yolo/src/darknet/yolo.weights     | model weights       }"
#       "{ camera_device  | 0     | camera device number}"
#       "{ video          |  /home/catkin_ws/src/futureCarCapstone/src/see-through-parking-using-augmented-reality/finalDemo/fisheye_lens/cctvView_yolo/cctvView_yolo.avi     | video or image for detection}"
#       "{ min_confidence | 0.24  | min confidence      }"
#       "{ class_names    |  /home/catkin_ws/src/yolo/src/darknet/data/coco.names     | class names         }";
        ...
        for i in range(result.shape[0]):
            ...
            if confidence > min_confidence:
                ...
                if objectClass < self.label.shape[0]:
                    ...
                    label = '%.2f' % confidence
                    label_to_put = '%s:%s' % (str(self.label[objectClass]).strip('\n'), label)
                    #print('self.label[0] is ', self.label[objectClass])
...
class DataLoadClass:
    ...
    def subscribeImg(self):
        ...
        self.rospySubImg = rospy.Subscriber(camera_topic, Image, self.callback)
    ...
    def callback(self, data):
        ...
        try:
            count = count + 1
            # print('count =', count)
            detectedImg = self.myDarknetInst.initDetection(self.bridge.imgmsg_to_cv2(data, "bgr8"))
        ...
        if flag_publishImg == 1:
            try:
                self.rospyPubImg.publish(self.bridge.cv2_to_imgmsg(detectedImg, "bgr8"))
            except CvBridgeError as e:
                print(e)
